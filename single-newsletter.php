                        ...
                        <center>
                            <table width="600" height="100%" align="center" cellspacing="0" cellpadding="0" border="0" style="font-family:'Open Sans','Arial','Verdana',sans-serif;font-size:12px;font-style:normal;font-weight:400;line-height:1.2;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing: grayscale;-moz-font-feature-settings:'liga','kern';border-spacing:0;border-collapse:collapse;padding:0;margin:0 auto;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;width:600px;color:#0A2342;background-color:#ffffff;border:1px solid #0A2342;">
                                <tbody>
                                                        ...
                                                        <td align="right" valign="top" style="width:200px; text-align: right; font-size: 12px; padding: 20px;">
                                                            ...
                                                            if (function_exists('pll_the_languages')) {
                                                                ...
                                                                foreach ($languages as $lang) {
                                                                    $i++;
                                                                    if($i>1){
                                                                        echo '| <a href="' . esc_url($lang['url']) . '" class="' . esc_attr($lang['classes']) . '" style="text-decoration: none; color:#0A2342;">' . esc_html($lang['name']) . '</a> ';
                                                                    }else{
                                                                        echo '<a href="' . esc_url($lang['url']) . '" class="' . esc_attr($lang['classes']) . '" style="text-decoration: none; color:#0A2342;">' . esc_html($lang['name']) . '</a> ';
                                                                    }
                                                ...
                                                if($title||$image||$description){
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top" style="padding:0px">
                                                            <table width="560" style="border-spacing:0;border-collapse:collapse;padding:0;margin:0 auto;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;width:560px; border-bottom:1px solid #0A2342;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:30px 20px 30px 10px; width:350px; vertical-align: top;">
                                                                            ...
                                                                            <?php }; ?>
                                                                            <?php if ( $url ) { ?>
                                                                                <div style="margin-top:20px;"><a href="<?php echo $url; ?>" style="display:inline-block; background-color:#fff; color:#0A2342; border:1px solid #0A2342; padding:5px 20px; text-decoration: none;"><?php echo cuhk_multilang_text("閱讀更多", "", "Read more"); ?></a></div>
                                                                            <?php }; ?>
                                                                        </td>
                                    ...
                                    <tr>
                                        <td align="left" valign="top" style="text-align: center; background-color:#0A2342; color:#fff;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td  align="center" valign="top" style="-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;width:600px;padding:20px 0px 0 0px; font-size:14px;line-height:20px;">
                                                            <a style="text-decoration:none; color:#fff;" href="http://www.history.cuhk.edu.hk/sitemap/" target="_blank">Sitemap</a><span style="display: inline-block;  margin-left: 12px; margin-right: 12px;">|</span><a style="text-decoration:none; color:#fff;" href="http://www.history.cuhk.edu.hk/contact/" target="_blank">Contact Us</a><span style="display: inline-block;  margin-left: 12px; margin-right: 12px;">|</span><a style="text-decoration:none; color:#fff;" href="http://www.cuhk.edu.hk/english/privacy.html" target="_blank">Privacy Policy</a><span style="display: inline-block;  margin-left: 12px; margin-right: 12px;">|</span><a style="text-decoration:none; color:#fff;" href="http://www.cuhk.edu.hk/english/disclaimer.html" target="_blank">Disclaimer</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="600" align="center" valign="top" style="-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;width:600px;padding:20px 0px;"><?php echo cuhk_multilang_text(date('Y') ."版權所有","","© Copyright ".date('Y')); ?><span style="display: inline-block;  margin-left: 12px; margin-right: 12px;">|</span><?php echo cuhk_multilang_text("香港中文大學歷史系","","The Chinese University of Hong Kong Department of History"); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
