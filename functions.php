...
function cuhk_chi_scripts()
{
	...
	if (is_page_template('tmp-postgraduate_research_students.php') || is_page_template('tmp-teaching-staff.php') || is_page_template('tmp-course-index.php') || is_page_template('tmp-research_project.php') || is_page_template('tmp-events.php') || is_page_template('tmp-old_events_index.php') || is_page_template('tmp-languagesevents.php') || is_page_template('tmp-home.php') || is_page_template('tmp-gallery.php')) {
