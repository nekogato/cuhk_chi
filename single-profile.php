		...
		<div class="section section_content people_detail_section">
			<div class="section_center_content small_section_center_content">
				...
				<div class="people_detail_content">
					<div class="back_btn_wrapper scrollin scrollinbottom"><a href="<?php echo pll_get_page_url("people/teaching-staff") ?>" class="back_btn"><?php echo cuhk_multilang_text("返回","","Back"); ?></a></div>
