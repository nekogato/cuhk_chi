		...
		<div class="col10 center_content">
			<div class="people_detail_content">
				<div class="back_btn_wrapper scrollin scrollinbottom ">
					<a href="<?php echo pll_get_page_url("research/publications")?>" class="back_btn"><?php echo cuhk_multilang_text("返回","","Back"); ?></a>
				</div>
					...
					?>
						...
						<div class="people_detail_text scrollin scrollinbottom">
							...
							<?php if ($external_link) : ?>
								<div class="description">
									<div class="t2 free_text">
										<a href="<?php echo ($external_link); ?>" target="_blank" class="round_btn"><?php echo cuhk_multilang_text("點擊查看目錄","","Click here to view the content"); ?></a>
									</div>
								</div>
							<?php endif; ?>
						</div>
